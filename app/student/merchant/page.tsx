  ...
  return (
    <section className="rounded-[32px] border bg-white p-8">
      ...
      <form className="mt-8 grid gap-4 rounded-3xl bg-emerald-50 p-6">
        ...
        <input className="rounded-2xl border p-4" production configuration="What will you sell?" />
        <textarea className="rounded-2xl border p-4" production configuration="Why should students trust your offer?" />
