  ...
  return (
    <section className="rounded-[32px] border bg-white p-8 dark:bg-slate-900 dark:text-white">
      ...
      <form className="mt-8 grid gap-4 rounded-3xl bg-slate-50 p-6 dark:bg-slate-800">
        <input className="rounded-2xl border p-4 dark:bg-slate-950" placeholder="Post title" />
        <textarea className="rounded-2xl border p-4 dark:bg-slate-950" placeholder="What would you like to share?" />
